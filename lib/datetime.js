...
const getMinutes = date => date.getUTCHours() * 60 + date.getMinutes();
const get12UTCHoursFromDate = time => time.getUTCHours() % 12 || 12;
const get12UTCDiffMinutes = lineDate => get12UTCHoursFromDate(systemDate()) * 60 + systemDate().getMinutes() -
    (get12UTCHoursFromDate(lineDate) * 60 + lineDate.getMinutes());
